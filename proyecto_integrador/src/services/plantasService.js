...
class PlantasService {
  ...
  async searchPlantas(termino) {
    try {
      const response = await fetch(`${API_URL}/api/plantas/buscar/${encodeURIComponent(termino)}`);
      const data = await response.json();
  ...
  async getPlantaCompleta(id) {
    try {
      const response = await fetch(`${API_URL}/api/plantas/${id}/completa`);
      const data = await response.json();
  ...
  async getPlantaPropiedades(id) {
    try {
      const response = await fetch(`${API_URL}/api/plantas/${id}/propiedades`);
      const data = await response.json();
  ...
  async getPlantaEnfermedades(id) {
    try {
      const response = await fetch(`${API_URL}/api/plantas/${id}/enfermedades`);
      const data = await response.json();
  ...
  async getPlantaUsos(id) {
    try {
      const response = await fetch(`${API_URL}/api/plantas/${id}/usos`);
      const data = await response.json();
  ...
  async getAllEnfermedades() {
    try {
      const response = await fetch(`${API_URL}/api/enfermedades`);
      const data = await response.json();
  ...
  async getEnfermedadPlantas(id) {
    try {
      const response = await fetch(`${API_URL}/api/enfermedades/${id}/plantas`);
      const data = await response.json();
  ...
  async getCategoriasPlanta() {
    try {
      const response = await fetch(`${API_URL}/api/categorias-plantas`);
      const data = await response.json();
  ...
  async getCategoriasEnfermedad() {
    try {
      const response = await fetch(`${API_URL}/api/categorias-enfermedades`);
      const data = await response.json();
